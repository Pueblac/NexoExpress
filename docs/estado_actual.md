...
**Meta (PILOTO v2, F0 registrado 09-07-2026 — PENDIENTE GATE G0):** [ActaExpressWeb] MT-04: el frontend envía `generarSintesis: true` mediante toggle en la pantalla de grabación. Primer ciclo completo bajo la metodología v2 en Modo M (Sonnet implementa). UX delegada al ciclo por el Director (diseño en F1, revisado por Gemini).
**Expediente (se abre en F1):** `auditorias/2026-07-09_mt04_toggle_sintesis/`
